...
for line in input_file.readlines():
    if line == "\n":
        totals.append(current_val)
        current_val = 0
    else:
        current_val = current_val + int(line)

print("Part 1: Max calories for single elf =", max(totals))
...
print("Part 2: Sum of Top 3 = ", (first + second + third))
