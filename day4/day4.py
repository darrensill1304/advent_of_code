...
# many of the assignments overlap. To try to quickly find overlaps and reduce duplicated effort, the Elves 
...
class Assignment:
    ...
    def overlaps(self, other):
        intersection = set(self.getList()) & set(other.getList())
...
def main():
    ...
    for line in input_file.readlines():
        ...
        ass1 = Assignment(first)
        ass2 = Assignment(second)
