...
this case, the sum is 188. Then, multiply that sum by the number that was just called when the board won, 24, to get the final score, 188 * 24 = 4512.
...
# Extract the called numbers from the first line
called_numbers = [int(x) for x in lines[0].strip().split(',')]

# Read each six lines as a new card
cards = []
